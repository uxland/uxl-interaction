import {getViewOptions, Interaction, registerView, unregisterView} from "../src/view-registry";
const assert = chai.assert;
const viewOptions: Interaction = {classifiers: 'classifiers', headerIcon: 'my-icon', parentClassifiers: 'parentClassifiers', parentSettings:{}, tag: 'my-view', url: 'my-view.html'};
